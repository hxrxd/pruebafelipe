...
@section('place')
  ...
  <div id="frame" class="row wrapper border-bottom white-bg page-heading" style="padding:60px; display:none">
    ...
    <div class="color-orange" style="padding:15px;font-size:16px;border-radius:10px;">
      <p style="text-align:center;">El diagnóstico realizado por estudiantes es una investigación que siempre se está mejorando y aún continúa en proceso de revisión. Por tal razón, algunos datos podrían no ser correctos.</p>
    </div>
          ...
          <div class="panel-heading">
            <div class="panel-options">
                <ul class="nav nav-tabs">
                    <li class="active tb"><a href="#tab-0" data-toggle="tab" style="font-size:16px;">Territorio</a></li>
                    <li class="tb"><a href="#tab-1" data-toggle="tab" style="font-size:16px;">Demografía</a></li>
                    <li class="tb"><a href="#tab-2" data-toggle="tab" style="font-size:16px;">Economía</a></li>
                    <li class="tb"><a href="#tab-3" data-toggle="tab" style="font-size:16px;">Salud</a></li>
                    <li class="tb"><a href="#tab-4" data-toggle="tab" style="font-size:16px;">Educación</a></li>
                    <li class="tb"><a href="#tab-5" data-toggle="tab" style="font-size:16px;">Ambiente</a></li>
                    <li class="tb"><a href="#tab-6" data-toggle="tab" style="font-size:16px;">Gestión Municipal</a></li>
                </ul>
            </div>
...
<script type="text/javascript">
  ...
  $(".tb").click(function() {
    $('html,body').animate({
        scrollTop: $(".tabs").offset().top},'slow');
  });
