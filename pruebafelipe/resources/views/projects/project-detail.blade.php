                ...
                <div class="ibox-content">
                  ...
                  {{Session::put('idpj', $idpj)}}
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="m-b-md">
                                <!--<button class="btn btn-white pull-right" type="button" style="margin-left:5px" onclick="showMessage('Opción no disponible','La opción de carga de documentos aún no está habilitada.')"><i class="fa fa-upload"></i>&nbsp;&nbsp;<span class="bold">Subir</span></button>-->
                                <a href="{{ url('project/edit')}}" class="btn btn-white pull-right" type="button"><i class="fa fa-edit"></i> Editar</a>
                                <h2>Informe</h2>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-5">
                            <dl class="dl-horizontal">
                                ...
                                <dt>Cohorte:</dt> <dd>  {{$cohort_str}}</dd>
                        ...
                        <div class="tab-pane active table-responsive" id="tab-1">
                          ...
                          <table id="activity-table" class="table table-striped">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  @if($act->status == 0)
                                    <td><label class="container"><input type="checkbox" value="{{$act->id}}" class="check-act" checked disabled><span class="checkmark"></span></label></td>
                                  ...
                                  @else
                                    <td><label class="container"><input type="checkbox" value="{{$act->id}}" class="check-act" disabled><span class="checkmark"></span></label></td>
                                  ...
                                  @endif
                                    ...
                                    <td>{{ $act->deadline}}</td>
                                    <td>
                                      <button id="{{$act->id}}" class="btn btn-info btn-sm" onclick="fillEdit('{{$act->id}}','{{$act->activity}}','{{$act->startdate}}','{{$act->deadline}}')" data-toggle="modal" data-target="#addActivityModal"><i class="fa fa-edit"></i></button>
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content animated fadeIn">
                          ...
                          <div class="modal-footer">
                            <a type="button" class="btn btn-primary edit-act" style="margin-left:5px;" data-dismiss="modal" onclick="location.reload();">Guardar cambios</a>
...
<script>
  ...
  $(window).on('load',function(){
    ...
    console.log("DIF_DATES: "+dif);
    console.log("DIF_TODAY: "+dif_today);
  ...
  $(document).ready(function () {
      $('.check-act').click(function(){
          ...
          if($(this).prop('checked')){
            ...
            $.get('/check/activity/'+idd, function (data) {
              console.log('DONE!');
            ...
            $.get('/uncheck/activity/'+idd, function (data) {
              console.log('UNDONE!');
  ...
  function fillEdit(id,activity,date1,date2){
    ...
    document.getElementById("deadline").value = date2;
  }
