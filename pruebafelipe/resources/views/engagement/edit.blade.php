                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Editar Contrato <small>Estas editando el contrato de {{$student->carne}}</h5>
                        ...
                        <div class="ibox-content">
                             ...
                             {!! Form::model($engagements,['route'=>['engagement.update',$engagements->id_engagement],'method'=>'PUT','class'=>'form-horizontal']) !!}

                                {!! Form::hidden('contract', $engagements->id_contracts);!!}
                                {!! Form::hidden('student', $engagements->student);!!}
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">Numero</label>
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        {!!Form::text('no',null,['class'=>'form-control','id'=>'no','placeholder'=>'Ingrese la duración en meses del contrato','required'=>''])!!}<span>Favor solo cambiar este dato si es necesario</span>
                                 ...
                                 <div class="form-group"><label class="col-sm-2 control-label">Año</label>
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        {!!Form::text('year',null,['class'=>'form-control','id'=>'year','placeholder'=>'Ingrese la duración en meses del contrato','required'=>''])!!}<span>Favor solo cambiar este dato si es necesario</span>
                                ...
                                <div class="form-group "><label class="col-sm-2 control-label">Fecha de Inicio</label>
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        {!! Form::date('initd', $engagements->initd,['class'=>'form-control','required'=>'']); !!}
                                ...
                                <div class="form-group "><label class="col-sm-2 control-label">Fecha Final</label>
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        {!! Form::date('endd', $engagements->endd,['class'=>'form-control','required'=>'']); !!}
