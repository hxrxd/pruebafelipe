...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-4">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <strong>{{substr($cohortx->cohorte,0,14)}}</strong>
            </li>
        </ol>
    </div>
</div>
                  ...
                  @else
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="m-b-md">
                                @if($dx->edit_flag == 100)
                                  <a href="{{ url('dx/edit')}}" class="btn btn-white pull-right" type="button"><i class="fa fa-eye"></i> Ver diagnóstico</a>
                                @else
                                  <a class="btn btn-white pull-right" type="button" data-toggle="modal" data-target="#myModal"><i class="fa fa-eye"></i> Ver diagnóstico</a>
                                @endif
                                <h2>Informe</h2>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-5">
                            <dl class="dl-horizontal">
                                ...
                                <dt>Equipo:</dt> <dd>{{$teamx->name}}</dd>
                                <dt>Cohorte:</dt> <dd>  {{substr($cohortx->cohorte,0,14)}}</dd>
  ...
  <div class="modal-dialog">
    <div class="modal-content animated fadeIn">
      <div class="modal-header">
        ...
        <i class="fa fa-minus-circle modal-icon"></i>
        <h4 class="modal-title">Diagnóstico aún en edición</h4>
        <h5>La vista del diagnóstico estará disponible cuando el equipo termine de editar.</h5>
      </div>
