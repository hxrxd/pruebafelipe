  ...
  function getReport(e) {
    ...
    if (filterRadio == 1) {
      ...
      if (typeReport == '0') {
        ...
        jQuery.ajax({
          url: '{{asset("stats/financing/getStatsGeneralFinancing/typeReport")}}'.replace('typeReport',typeReport),
          type:"GET",
          dataType:"json",
