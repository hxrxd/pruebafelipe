  ...
  <div class="col-lg-12">
    <div class="ibox float-e-margins">
      ...
      <div class="ibox-content">
        {!! Form::model($prov,['route'=>['inventory.provider.update',$prov->id],'class'=>'form-horizontal','method'=>'PUT']) !!}
        ...
        <div class="form-group"><label class="col-sm-2 control-label" style="font-size:11px">Nombre *</label>
          <div class="col-sm-10">
            {!!Form::text('name',null,['class'=>'form-control','id'=>'name','placeholder'=>'Ingrese el nombre del proveedor'])!!}
          </div>
        </div>
