        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-content text-center p-md">
                   ...
                   {!!Form::checkbox('reqAct', null,$reqAct->act, ['id'=>$reqAct->description, 'name'=>'reqAct','class'=>'js-switch'])!!}
                    <p>     
                      Por medio de esta consola de administración puede confirmar y editar solucitudes de disciplinas a sedes del programa EPSUM, recurde que una sede puede ser un CAP, Puesto de Salud, Municipalidad, Gobernación o cualquier institución asignada al estudiante. Las disciplinas presentadas en la tabla son obtenidas de la cohorte anterior de cada supervisor.
                    </p>

                    
                    <a href="{{ url('getAssignmentForCoor')}}" class="btn btn-primary" role="button"><i class="fa fa-print"></i> Imprimir documento de solicitudes </a>
                    <a href="{{ url('getAssignment')}}" class="btn btn-primary" role="button"><i class="fa fa-print"></i> Imprimir documento de solicitudes de unidades académicas asociadas</a>
    ...
    <script>
     ...
     <script>
        ...
        $(document).ready(function(){
            ...
            $('input[name=reqAct]').change(function(){
                if($(this).is(':checked')) {
                    idAct=$(this).attr('id');
                    flag= 1;
                } else {
                ...
                //
                jQuery.ajax({
                    url: '{{asset("request/disciplines/actrequeriment/idRequest/value")}}'.replace('idRequest/value', idAct+'/'+flag),
                    type:"GET",
                    dataType:"json",
                    success:function(data){
                        //console.log('console:'+data['result']);
                        console.log(data['result']);
                        toastr.success('Se realizado el cambio sobre la activación de la solicitud de disciplinas con éxito','¡Cambio guardado!');
                    },error:function(){
                        console.log('ERROR');
                        toastr.success('Se ha producido un error, contactar con los desarrolladores','¡ERROR!');
                    }
