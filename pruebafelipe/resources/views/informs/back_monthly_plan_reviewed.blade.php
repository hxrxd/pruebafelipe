            ...
            <div class="col-sm-12">
              ...
              @if($report->validated == 1)
                ...
                <div id="download-notification" class="animated fadeInUp" style="display:none;">
                  ...
                  <p style="margin:10px 200px 0px 285px;font-size:16px;"><strong>5.</strong> Cambia el nombre y el Cargo de la Autoridad Local que firmará tu informe</p>
                  <p style="margin:10px 200px 0px 285px;font-size:16px;"><strong>6.</strong> Si tu carrera es Ingenieria del CUNOC cambia tus fechas en el primer y último mes</p>
